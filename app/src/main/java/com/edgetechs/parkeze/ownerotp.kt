...
class ownerotp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ownerotp)
    ...
    private val mCallbacks: PhoneAuthProvider.OnVerificationStateChangedCallbacks =
        object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(phoneAuthCredential: PhoneAuthCredential) {
                ...
                Toast.makeText(this@ownerotp, "Otp sent succesfully", Toast.LENGTH_SHORT).show()
            }

            override fun onVerificationFailed(e: FirebaseException) {
                Toast.makeText(this@ownerotp, e.message, Toast.LENGTH_SHORT).show()
            }
        }
